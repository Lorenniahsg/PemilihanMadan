...
) ENGINE=InnoDB AUTO_INCREMENT=210347 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=54062 DEFAULT CHARSET=latin1;
...
/*Table structure for table `adak_dim_transfer` */

DROP TABLE IF EXISTS `adak_dim_transfer`;

CREATE TABLE `adak_dim_transfer` (
  `dim_transfer_id` int(11) NOT NULL AUTO_INCREMENT,
  `dim_id` int(11) DEFAULT NULL,
  `ta` varchar(30) DEFAULT '0',
  `sem_ta` int(11) DEFAULT '0',
  `registrasi_id` int(11) DEFAULT NULL,
  `universitas_asal` varchar(200) DEFAULT NULL,
  `fakultas_asal` varchar(200) DEFAULT NULL,
  `prodi_asal` varchar(200) DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`dim_transfer_id`),
  KEY `dim_id` (`dim_id`),
  KEY `registrasi_id` (`registrasi_id`),
  CONSTRAINT `adak_dim_transfer_ibfk_1` FOREIGN KEY (`dim_id`) REFERENCES `dimx_dim` (`dim_id`),
  CONSTRAINT `adak_dim_transfer_ibfk_2` FOREIGN KEY (`registrasi_id`) REFERENCES `adak_registrasi` (`registrasi_id`)
...
/*Table structure for table `adak_kuliah_transfer` */

DROP TABLE IF EXISTS `adak_kuliah_transfer`;

CREATE TABLE `adak_kuliah_transfer` (
  `kuliah_transfer_id` int(11) NOT NULL AUTO_INCREMENT,
  `dim_transfer_id` int(11) DEFAULT NULL,
  `nilai_id` int(11) DEFAULT NULL,
  `grade` varchar(2) DEFAULT NULL,
  `matakuliah_asal` varchar(200) DEFAULT NULL,
  ...
  `updated_by` varchar(32) DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`kuliah_transfer_id`),
  KEY `dim_transfer_id` (`dim_transfer_id`),
  KEY `nilai_id` (`nilai_id`),
  KEY `kuliah_id` (`kuliah_id`),
  CONSTRAINT `adak_kuliah_transfer_ibfk_1` FOREIGN KEY (`dim_transfer_id`) REFERENCES `adak_dim_transfer` (`dim_transfer_id`),
  CONSTRAINT `adak_kuliah_transfer_ibfk_2` FOREIGN KEY (`nilai_id`) REFERENCES `nlai_nilai` (`nilai_id`),
  CONSTRAINT `adak_kuliah_transfer_ibfk_3` FOREIGN KEY (`kuliah_id`) REFERENCES `krkm_kuliah` (`kuliah_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=20769 DEFAULT CHARSET=latin1;

/*Table structure for table `adak_transfer_file` */

DROP TABLE IF EXISTS `adak_transfer_file`;

CREATE TABLE `adak_transfer_file` (
  `transfer_file_id` int(11) NOT NULL AUTO_INCREMENT,
  `dim_transfer_id` int(11) DEFAULT NULL,
  `nama_file` text,
  ...
  PRIMARY KEY (`transfer_file_id`),
  KEY `dim_transfer_id` (`dim_transfer_id`),
  CONSTRAINT `adak_transfer_file_ibfk_1` FOREIGN KEY (`dim_transfer_id`) REFERENCES `adak_dim_transfer` (`dim_transfer_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=55586 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=10486 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=14368 DEFAULT CHARSET=latin1;
...
CREATE TABLE `askm_izin_bermalam` (
  ...
  `status_pelanggaran` tinyint(1) DEFAULT '0' COMMENT '0:default,1:diproses/PK,2:abaikan',
  ...
  CONSTRAINT `askm_izin_bermalam_ibfk_2` FOREIGN KEY (`pelanggaran_id`) REFERENCES `askm_dim_pelanggaran` (`pelanggaran_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=31881 DEFAULT CHARSET=latin1;

/*Table structure for table `askm_izin_dosen_matkul` */

DROP TABLE IF EXISTS `askm_izin_dosen_matkul`;

CREATE TABLE `askm_izin_dosen_matkul` (
  `izin_dosen_matkul_id` int(11) NOT NULL AUTO_INCREMENT,
  `pengajaran_id` int(11) DEFAULT NULL,
  `izin_keluar_id` int(11) NOT NULL,
  `status_request_dosen_matkul` int(11) NOT NULL DEFAULT '1',
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`izin_dosen_matkul_id`),
  KEY `FK_izin_keluar_id` (`izin_keluar_id`),
  KEY `askm_r_status` (`status_request_dosen_matkul`),
  KEY `dosen_matkul_id` (`dosen_matkul_id`),
  KEY `pengajaran_id` (`pengajaran_id`),
  CONSTRAINT `askm_izin_dosen_matkul_ibfk_1` FOREIGN KEY (`izin_keluar_id`) REFERENCES `askm_izin_keluar` (`izin_keluar_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `askm_izin_dosen_matkul_ibfk_2` FOREIGN KEY (`dosen_matkul_id`) REFERENCES `hrdx_pegawai` (`pegawai_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `askm_izin_dosen_matkul_ibfk_3` FOREIGN KEY (`pengajaran_id`) REFERENCES `adak_pengajaran` (`pengajaran_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `askm_r_status` FOREIGN KEY (`status_request_dosen_matkul`) REFERENCES `askm_r_status_request` (`status_request_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `askm_izin_keluar` (
  ...
  `status_request_dosen_matkul` int(11) DEFAULT NULL,
  ...
  KEY `status_request_dosen_matkul` (`status_request_dosen_matkul`),
  KEY `pelanggaran_id` (`pelanggaran_id`),
  ...
  CONSTRAINT `askm_izin_keluar_ibfk_6` FOREIGN KEY (`status_request_dosen_matkul`) REFERENCES `askm_r_status_request` (`status_request_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `askm_izin_keluar_ibfk_7` FOREIGN KEY (`pelanggaran_id`) REFERENCES `askm_dim_pelanggaran` (`pelanggaran_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=8940 DEFAULT CHARSET=latin1;
...
CREATE TABLE `askm_log_mahasiswa` (
  ...
  `lokasi_log_id` int(11) DEFAULT NULL,
  `pelanggaran_id` int(11) DEFAULT NULL,
  `status_pelanggaran` tinyint(1) DEFAULT NULL COMMENT '0:default,1:diproses/PK,2:abaikan',
  `deleted` tinyint(1) DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
  `deleted_by` varchar(32) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  ...
  KEY `pelanggaran_id` (`pelanggaran_id`),
  CONSTRAINT `askm_log_mahasiswa_ibfk_1` FOREIGN KEY (`pelanggaran_id`) REFERENCES `askm_dim_pelanggaran` (`pelanggaran_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=490009 DEFAULT CHARSET=latin1;
...
/*Table structure for table `askm_periode` */

DROP TABLE IF EXISTS `askm_periode`;

CREATE TABLE `askm_periode` (
  `periode_id` int(11) NOT NULL AUTO_INCREMENT,
  `nama` varchar(45) DEFAULT NULL,
  `jumlah_hari` int(11) DEFAULT NULL,
  `batas_toleransi` int(11) DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
  `deleted_by` varchar(32) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
...
/*Table structure for table `askm_waktu_keluar_masuk` */

DROP TABLE IF EXISTS `askm_waktu_keluar_masuk`;

CREATE TABLE `askm_waktu_keluar_masuk` (
  `waktu_keluar_masuk_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`waktu_keluar_masuk_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=283 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `cist_atasan_surat_tugas` (
  ...
  KEY `fk_cist_atasan_hrdx_pegawai` (`pegawai_id`),
  ...
  CONSTRAINT `fk_cist_atasan_hrdx_pegawai` FOREIGN KEY (`pegawai_id`) REFERENCES `hrdx_pegawai` (`pegawai_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=274 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `cist_surat_tugas` (
  ...
  `submit_laporan` date DEFAULT NULL,
  `status_id` int(11) DEFAULT NULL,
...
CREATE TABLE `cist_surat_tugas_assignee` (
  ...
  KEY `FK_cist_surat_tugas_assignee` (`pegawai_id`),
  ...
  CONSTRAINT `fk_cist_assignee_hrdx_pegawai` FOREIGN KEY (`pegawai_id`) REFERENCES `hrdx_pegawai` (`pegawai_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `dimx_alumni` (
  ...
  `no_sk_yudisium` varchar(100) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=3915 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=11814 DEFAULT CHARSET=latin1;
...
/*Table structure for table `krkm_kuliah_ekivalen` */

DROP TABLE IF EXISTS `krkm_kuliah_ekivalen`;

CREATE TABLE `krkm_kuliah_ekivalen` (
  `kuliah_ekivalen_id` int(11) NOT NULL AUTO_INCREMENT,
  `mk_asal` int(11) NOT NULL,
  `mk_tujuan` int(11) NOT NULL,
  `is_asal_many` tinyint(1) DEFAULT '0',
  `is_tujuan_many` tinyint(1) DEFAULT '0',
  `deleted` tinyint(1) DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
  `deleted_by` varchar(32) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`kuliah_ekivalen_id`),
  KEY `mk_asal` (`mk_asal`),
  KEY `mk_tujuan` (`mk_tujuan`),
  CONSTRAINT `krkm_kuliah_ekivalen_ibfk_1` FOREIGN KEY (`mk_asal`) REFERENCES `krkm_kuliah` (`kuliah_id`),
  CONSTRAINT `krkm_kuliah_ekivalen_ibfk_2` FOREIGN KEY (`mk_tujuan`) REFERENCES `krkm_kuliah` (`kuliah_id`)
...
CREATE TABLE `nlai_nilai` (
  ...
  `isekivalen` tinyint(1) DEFAULT '0',
  `deleted` tinyint(1) DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
  `deleted_by` varchar(32) DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=116616 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=89513 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=68367 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=138987 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=149762 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=94105 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=108366 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=127204 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=135352 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=42149 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=34890 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=19033 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=81800 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=27713 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=13231 DEFAULT CHARSET=latin1;
...
/*Table structure for table `skkm_bukti_file` */

DROP TABLE IF EXISTS `skkm_bukti_file`;

CREATE TABLE `skkm_bukti_file` (
  `bukti_id` int(11) NOT NULL AUTO_INCREMENT,
  `filename` varchar(100) NOT NULL,
  `filepath` varchar(100) DEFAULT NULL,
  `daftar_kegiatan_id` int(11) DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
  `deleted_by` varchar(32) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`bukti_id`),
  KEY `FK_daftar_bukti` (`daftar_kegiatan_id`),
  CONSTRAINT `FK_daftar_bukti` FOREIGN KEY (`daftar_kegiatan_id`) REFERENCES `skkm_daftar_kegiatan_mahasiswa` (`daftar_kegiatan_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3431 DEFAULT CHARSET=latin1;

/*Table structure for table `skkm_daftar_kegiatan_mahasiswa` */

DROP TABLE IF EXISTS `skkm_daftar_kegiatan_mahasiswa`;

CREATE TABLE `skkm_daftar_kegiatan_mahasiswa` (
  `daftar_kegiatan_id` int(11) NOT NULL AUTO_INCREMENT,
  `poin_mahasiswa_id` int(11) DEFAULT NULL,
  `nama_kegiatan` varchar(100) DEFAULT NULL,
  `status_id` int(11) DEFAULT '1',
  `verifikator` int(11) DEFAULT NULL,
  `indeks_kegiatan_id` int(11) DEFAULT NULL,
  `desc` text,
  `ta` varchar(5) DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`daftar_kegiatan_id`),
  KEY `verifikator_id` (`verifikator`),
  KEY `id_indeks` (`indeks_kegiatan_id`),
  KEY `skkm_status_daftar_kegiatan` (`status_id`),
  KEY `skkm_daftar_kegiatan_mahasiswa_poin_mahasiswa` (`poin_mahasiswa_id`),
  CONSTRAINT `id_indeks` FOREIGN KEY (`indeks_kegiatan_id`) REFERENCES `skkm_indeks_kegiatan` (`indeks_kegiatan_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `skkm_daftar_kegiatan_mahasiswa_poin_mahasiswa` FOREIGN KEY (`poin_mahasiswa_id`) REFERENCES `skkm_poin_mahasiswa` (`poin_mahasiswa_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `skkm_status_daftar_kegiatan` FOREIGN KEY (`status_id`) REFERENCES `skkm_r_status` (`status_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `verifikator_id` FOREIGN KEY (`verifikator`) REFERENCES `hrdx_pegawai` (`pegawai_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3439 DEFAULT CHARSET=latin1;

/*Table structure for table `skkm_indeks_kegiatan` */

DROP TABLE IF EXISTS `skkm_indeks_kegiatan`;

CREATE TABLE `skkm_indeks_kegiatan` (
  `indeks_kegiatan_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`indeks_kegiatan_id`),
  KEY `skkm_parent_indeks_kegiatan` (`parent`),
  CONSTRAINT `skkm_parent_indeks_kegiatan` FOREIGN KEY (`parent`) REFERENCES `skkm_indeks_kegiatan` (`indeks_kegiatan_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=264 DEFAULT CHARSET=latin1;

/*Table structure for table `skkm_poin_mahasiswa` */

DROP TABLE IF EXISTS `skkm_poin_mahasiswa`;

CREATE TABLE `skkm_poin_mahasiswa` (
  `poin_mahasiswa_id` int(11) NOT NULL AUTO_INCREMENT,
  `dim_id` int(11) NOT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`poin_mahasiswa_id`),
  KEY `skkm_poin_mahasiswa_dim` (`dim_id`),
  CONSTRAINT `skkm_poin_mahasiswa_dim` FOREIGN KEY (`dim_id`) REFERENCES `dimx_dim` (`dim_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1038 DEFAULT CHARSET=latin1;

/*Table structure for table `skkm_r_poin_prodi_min` */

DROP TABLE IF EXISTS `skkm_r_poin_prodi_min`;

CREATE TABLE `skkm_r_poin_prodi_min` (
  `poin_prodi_min_id` int(11) NOT NULL AUTO_INCREMENT,
  `prodi_id` int(11) NOT NULL,
  `poin_min` float NOT NULL DEFAULT '0',
  `pca_min` float DEFAULT '0',
  `matrikulasi_min` float DEFAULT '0',
  `other_min` float DEFAULT '0',
  `deleted` tinyint(1) DEFAULT '0',
  `deleted_at` datetime DEFAULT NULL,
  `deleted_by` varchar(32) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`poin_prodi_min_id`),
  KEY `skkm_poin_prodi_min_inst_prodi` (`prodi_id`),
  CONSTRAINT `skkm_poin_prodi_min_inst_prodi` FOREIGN KEY (`prodi_id`) REFERENCES `inst_prodi` (`ref_kbk_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*Table structure for table `skkm_r_status` */

DROP TABLE IF EXISTS `skkm_r_status`;

CREATE TABLE `skkm_r_status` (
  `status_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `desc` text,
  `deleted` tinyint(1) DEFAULT '0',
...
CREATE TABLE `srvy_kuesioner` (
  ...
  CONSTRAINT `srvy_kuesioner_ibfk_1` FOREIGN KEY (`pegawai_id`) REFERENCES `hrdx_pegawai` (`pegawai_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=2846851 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=281309 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=60810 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=2771 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=2548062 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=6074 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=12616 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=15994 DEFAULT CHARSET=latin1;
...
/* Procedure structure for procedure `FINCGENVAMANDIRI` */

/*!50003 DROP PROCEDURE IF EXISTS  `FINCGENVAMANDIRI` */;

DELIMITER $$

/*!50003 CREATE DEFINER="root"@"%" PROCEDURE "FINCGENVAMANDIRI"()
BEGIN
DECLARE n INT DEFAULT 0;
DECLARE i INT DEFAULT 0;
DECLARE counter INT DEFAULT 0;
DECLARE dobel INT DEFAULT 0;
DECLARE dim_nama varchar(500);
DECLARE sysx_user_id int default 0;
SELECT COUNT(*) FROM cis_production.`dimx_dim` WHERE thn_masuk = 2019 AND deleted = 0 INTO n;
SET i=0;
WHILE i<n DO
	SELECT nama FROM cis_production.`dimx_dim` WHERE thn_masuk = 2019 AND deleted = 0 LIMIT i,1 INTO dim_nama;
	IF (SELECT COUNT(*) FROM cis_finance_production.sysx_user WHERE `name` = dim_nama AND deleted = 0 > 1) THEN
		set dobel = dobel + 1;
	ELSEIF (SELECT COUNT(*) FROM cis_finance_production.sysx_user WHERE `name` = dim_nama AND deleted = 0 > 0) THEN
		SELECT user_id FROM cis_finance_production.sysx_user WHERE `name` = dim_nama AND deleted = 0 LIMIT 1 INTO sysx_user_id;
...
/* Procedure structure for procedure `KOLBPENULIS` */

/*!50003 DROP PROCEDURE IF EXISTS  `KOLBPENULIS` */;

DELIMITER $$

/*!50003 CREATE DEFINER="cis_db_admin"@"%" PROCEDURE "KOLBPENULIS"()
BEGIN
DECLARE n INT DEFAULT 0;
DECLARE i INT DEFAULT 0;
DECLARE kompo_id INT DEFAULT 0;
DECLARE pegawai_id INT DEFAULT 262;
SELECT COUNT(*) FROM kolb_komponen WHERE buku_id = 21 AND deleted = 0 INTO n;
SET i=0;
WHILE i<n DO
	SELECT komponen_id FROM kolb_komponen WHERE buku_id = 21 AND deleted = 0 LIMIT i,1 INTO kompo_id;
	INSERT INTO kolb_penulis(`komponen_id`, `pegawai_id`) VALUES(kompo_id, pegawai_id);
  SET i = i + 1;
END WHILE;
END */$$
DELIMITER ;
